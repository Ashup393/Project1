...
const handleregister =(e)=>{
  ...
  return (
    <div className='register'>
     ...
     {inputs.map((input)=> (
        <Forminput key={inputs.id} {...inputs}  placeholder={inputs.placeholder}  value={inputvalue[input.name]}
        onChange={handleChange}
        />
     ))}
     <Link to='/login'className='Newlink'>Already Login</Link>
     <Link className='forgetlink'>Forget Password?</Link>
        {/* <Forminput placeholder='Username'/>
        <Forminput placeholder='Email'/>
        <Forminput placeholder='Password'/>
        <Forminput placeholder='ConfirmPassword'/> */}
        <button type='submit' onClick={handleregister} ><Link to ='/login'></Link>Sign in </button>
        ...
        <a href='https://github.com/login' className='forwardclass'><ArrowForwardIcon/></a>
        </div>
